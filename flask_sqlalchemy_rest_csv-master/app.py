...
# Database
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql://{}:{}@localhost/{}".format(credentials.user, credentials.password, credentials.database)
...
#need a class for each data set and table
#make a route that queries a year as a parameter in this code and query that year
